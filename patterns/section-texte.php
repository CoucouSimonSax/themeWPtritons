...
<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--xxxl)">
	...
	<!-- wp:heading {"level":2,"style":{"typography":{"letterSpacing":"-0.015em"}},"fontSize":"xxl"} -->
	<h2 class="wp-block-heading has-xxl-font-size" style="letter-spacing:-0.015em">Intertitre de section</h2>
	<!-- /wp:heading -->
